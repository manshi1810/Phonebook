...
public class ContactDAO extends HttpServlet {
	...
	public boolean saveContact(Contact c) {
		...
		try {
			...
			String sql = "insert into contact(name,email,phno,address,userid) values(?,?,?,?,?)";
	...
	public boolean updateContact(int nid,String n,String e, String p,String a) {
		boolean f = false;

		try {

			String sql = "update contact set name=?, email=?, phno=?, address=? where id=?";
			PreparedStatement ps = conn.prepareStatement(sql);
